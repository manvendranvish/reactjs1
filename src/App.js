...
function App() {
  return (
    <div className="App">
          <LeftsideBar profileimg = {profileimg}/>
          <section id="hero" className="d-flex flex-column justify-content-center align-items-center">
            <div className="hero-container nav" >
              <h1>Manvendra Pratap Singh</h1>
              <p>I'm <span className="typed" data-typed-items="Designer, Developer, Freelancer, Photographer"></span></p>
            </div>
          </section>
          <main id="main">
            <AboutUs profileimg = {profileimg} />
            ...
            <footer id="footer">
                <div className="container">
                    <div className="copyright">&copy; Copyright <strong><span>iPortfolio</span></strong>
                    </div>
                </div>
            </footer>
